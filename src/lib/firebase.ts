...
const firebaseConfig = {
  ...
  // Must be the bucket name (not the domain). Example: project-id.appspot.com
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "cadeala-cd61d.appspot.com",
